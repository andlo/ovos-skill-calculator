...
URL = "https://github.com/andlo/ovos-skill-calculator"
SKILL_CLAZZ = "Calculator"
PYPI_NAME = "ovos-skill-calculator"
...
setup(
    name=PYPI_NAME,
    version=get_version(),
    description="A basic calculator skill for OVOS - add, subtract, multiply, divide, percentages, square roots, fully offline",
